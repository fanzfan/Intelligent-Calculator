...
public class AlphaAPISample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println(engine.toURL(query, "result"));
            System.out.println();
            ...
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new URL(engine.toURL(query)).openStream()));
            String inputLine;
